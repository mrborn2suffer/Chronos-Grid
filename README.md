...
10. [Versioning & Release History](#versioning--release-history)
11. [License](#license)
...
# 4️⃣ (Optional) Make helper scripts executable
...
|---------|------|-------------|
| **v1.0.0** | 2026‑06‑30 | First stable release – core ranking engine, UI, Excel exporter, auto‑converter, and back‑dated git history script. |
| **v0.9.0** | 2026‑06‑15 | Beta – initial data model and UI skeleton. |
| **v0.8.0** | 2026‑05‑28 | Added dynamic regex analyser and job‑description modal. |

We use **Semantic Versioning** (`MAJOR.MINOR.PATCH`). Tags are pushed to GitHub and associated with release notes.
